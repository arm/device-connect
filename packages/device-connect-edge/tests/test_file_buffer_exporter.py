...
from device_connect_edge.telemetry.file_buffer_exporter import (
...
class TestFileBufferSpanExporter:
    def test_delegate_success(self, tmp_path):
        ...
        with patch("device_connect_edge.telemetry.file_buffer_exporter.SpanExportResult", _FakeExportResult):
