...
class TestNoOpTracer:
    ...
    def test_noop_span_context_manager(self):
        from device_connect_edge.telemetry.tracer import _NoOpTracer, _NoOpSpan
    ...
    def test_noop_span_methods_dont_raise(self):
        from device_connect_edge.telemetry.tracer import _NoOpSpan
...
class TestNoOpMetrics:
    ...
    def test_noop_instrument_methods(self):
        from device_connect_edge.telemetry.metrics import _NoOpInstrument
...
class TestMetricsClientSingleton:
    ...
    def test_get_metrics_returns_client(self):
        from device_connect_edge.telemetry.metrics import get_metrics, MetricsClient
...
class TestGetTracer:
    ...
    def test_get_tracer_returns_usable(self):
        from device_connect_edge.telemetry.tracer import get_tracer
    ...
    def test_get_current_trace_id_returns_hex(self):
        from device_connect_edge.telemetry.tracer import get_current_trace_id
...
class TestPropagation:
    ...
    def test_inject_into_payload_adds_fields(self):
        from device_connect_edge.telemetry.propagation import inject_into_payload
    ...
    def test_extract_from_payload_does_not_raise(self):
        from device_connect_edge.telemetry.propagation import extract_from_payload
    ...
    def test_inject_extract_meta_roundtrip(self):
        ...
        from device_connect_edge.telemetry.propagation import inject_into_meta, extract_from_meta
...
class TestReExports:
    ...
    def test_status_code_values(self):
        from device_connect_edge.telemetry.tracer import StatusCode
...
class TestDeviceConnectTelemetryConfig:
    ...
    def test_is_enabled_importable(self):
        from device_connect_edge.telemetry import is_enabled

        # Should return a bool
        assert isinstance(is_enabled(), bool)

    def test_public_api_importable(self):
        from device_connect_edge.telemetry import (
    ...
    def test_disabled_via_env(self):
        ...
        import device_connect_edge.telemetry.config as cfg
        ...
        try:
            ...
            with patch.dict("os.environ", {"OTEL_SDK_DISABLED": "true"}):
                from device_connect_edge.telemetry.config import DeviceConnectTelemetry
...
class TestDictCarrier:
    ...
    def test_dict_carrier_is_dict(self):
        from device_connect_edge.telemetry.propagation import _DictCarrier
