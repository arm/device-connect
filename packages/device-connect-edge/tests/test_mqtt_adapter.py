...
class TestMQTTClientInit:
    ...
    @patch("device_connect_edge.messaging.mqtt_adapter.MQTTClient", new_callable=lambda: MagicMock)
    ...
    @patch("device_connect_edge.messaging.mqtt_adapter.MQTTClient", None)
