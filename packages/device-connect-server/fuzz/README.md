...
cd packages/device-connect-server
python fuzz/fuzz_credentials.py fuzz/corpus/credentials_json/ -max_total_time=300
...
python fuzz/fuzz_credentials.py fuzz/corpus/credentials_json/ -max_total_time=3600
