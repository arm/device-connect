...
from device_connect_sdk.drivers.decorators import build_function_schema, build_event_schema
...
class DeviceDriver(ABC):
    ...
    def transport(self) -> Optional["DriverTransport"]:  # noqa: F821
        ...
        if self._device is None or self._device.messaging is None:
            return None
        from device_connect_sdk.drivers.transport import DriverTransport
