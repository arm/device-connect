...
Quick start:
    ...
    from device_connect_sdk.telemetry import DeviceConnectTelemetry
    ...
    from device_connect_sdk.telemetry import get_tracer, get_metrics
    tracer = get_tracer()
    metrics = get_metrics()
...
from device_connect_sdk.telemetry.config import DeviceConnectTelemetry, is_enabled
from device_connect_sdk.telemetry.tracer import get_tracer, get_current_trace_id
