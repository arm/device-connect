...
to :class:`~device_connect_sdk.discovery_provider.DiscoveryProvider`.

This client is transport-only — it formats JSON-RPC messages and sends
them via :class:`~device_connect_sdk.messaging.base.MessagingClient`.
...
class RegistryClient:
    ...
    Implements the :class:`~device_connect_sdk.discovery_provider.DiscoveryProvider`
