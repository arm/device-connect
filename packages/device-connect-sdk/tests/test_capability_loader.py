"""Unit tests for device_connect_sdk.drivers.capability_loader module.
...
from device_connect_sdk.drivers.capability_loader import (
    CapabilityLoader,
)
...
from device_connect_sdk.drivers.decorators import rpc, emit
