"""Unit tests for device_connect_sdk.messaging.nats_adapter — NATSAdapter.
...
# NATS client.  Every test patches "device_connect_sdk.messaging.nats_adapter.NATS".
# ---------------------------------------------------------------------------
...
class TestNATSClientInit:
    ...
    @patch("device_connect_sdk.messaging.nats_adapter.NATS")
