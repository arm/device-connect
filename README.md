...
An open-source protocol by Arm for connecting devices, robots, and AI agents. Works device-to-device with zero infrastructure, or scales to thousands of devices with a pub/sub router. Supports Zenoh, NATS, and MQTT backends.
